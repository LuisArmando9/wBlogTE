            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <div class="btn-group dropleft">
                        <a class=" mr-3 btn btn-bell-n dropdown-toggle-split" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                            <i class="fa fa-bell text-primary" aria-hidden="true"></i>
                            @if($hasMaxComments)
                                <span class="bg-primary counter text-light">9+</span>
                            @else
                        ...
                        <div class="dropdown-menu bg-primary">
                            ...
                            <a class="dropdown-item text-white notification-hover"
                            ...
                            @endforeach
                            <a class="dropdown-item text-white notification-hover" href="{{route('comment.index')}}">
                                <b>Ver todos los comentarios</b> 
                            </a>
